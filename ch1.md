...
### 用户故事鼓励延迟细节
使用用户故事的另一个优势在于我们鼓励团队延迟手机细节。这一点其实是上面提到的用迭代的方法编写故事的另一种表现形式。我们不必一次写出所有故事，也不必一次把一个故事写到完美，我们可以逐渐的将其细化，从模糊到清晰，这样的好处在于，我们可以随时根据项目的进展，获得用户的反馈，并使用这些反馈来改进我们的用户故事。通过这样的方式，我们就可以在一定程度上引导用户发现他们自己的需求，一旦我们开了个好头，进入良性的循环之中